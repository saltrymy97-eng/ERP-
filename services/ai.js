// services/ai.js – الذكاء الاصطناعي المحلي (Llama 3.2 1B + صوت + تحليل)
import { getQuery } from './db';

// ========== إعدادات Groq ==========
const GROQ_API_KEY = 'gsk_your_api_key_here'; // استبدل بمفتاحك من groq.com
const GROQ_MODEL = 'llama-3.2-1b-preview'; // نموذج خفيف ومجاني
...
export function startVoiceRecognition(callback) {
  ...
  recognition.onerror = (event) => {
    callback('❌ خطأ في التسجيل الصوتي', null);
  };
